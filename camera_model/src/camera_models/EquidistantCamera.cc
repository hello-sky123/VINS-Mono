...
:  Camera::Parameters(KANNALA_BRANDT),
   m_k2(0.0), m_k3(0.0), m_k4(0.0), m_k5(0.0),
   m_mu(0.0), m_mv(0.0), m_u0(0.0), m_v0(0.0)
{ }

EquidistantCamera::Parameters::Parameters(const std::string& cameraName, int w, int h, double k2, double k3, double k4, double k5,
                                          double mu, double mv, double u0, double v0)
:  Camera::Parameters(KANNALA_BRANDT, cameraName, w, h),
   m_k2(k2), m_k3(k3), m_k4(k4), m_k5(k5),
   m_mu(mu), m_mv(mv), m_u0(u0), m_v0(v0)
{ }

double& EquidistantCamera::Parameters::k2() {
  return m_k2;
}

double& EquidistantCamera::Parameters::k3() {
  return m_k3;
}

double& EquidistantCamera::Parameters::k4() {
  return m_k4;
}

double& EquidistantCamera::Parameters::k5() {
  return m_k5;
}

double& EquidistantCamera::Parameters::mu() {
  return m_mu;
}

double& EquidistantCamera::Parameters::mv() {
  return m_mv;
}

double& EquidistantCamera::Parameters::u0() {
  return m_u0;
}

double& EquidistantCamera::Parameters::v0() {
  return m_v0;
}

double EquidistantCamera::Parameters::k2() const {
  return m_k2;
}

double EquidistantCamera::Parameters::k3() const {
  return m_k3;
}

double EquidistantCamera::Parameters::k4() const {
  return m_k4;
}

double EquidistantCamera::Parameters::k5() const {
  return m_k5;
}

double EquidistantCamera::Parameters::mu() const {
  return m_mu;
}

double EquidistantCamera::Parameters::mv() const {
  return m_mv;
}

double EquidistantCamera::Parameters::u0() const {
  return m_u0;
}

double EquidistantCamera::Parameters::v0() const {
  return m_v0;
}
...
EquidistantCamera::Parameters& EquidistantCamera::Parameters::operator=(const EquidistantCamera::Parameters& other) {
  if (this != &other) {
...
EquidistantCamera::EquidistantCamera(const std::string& cameraName, int imageWidth, int imageHeight, double k2, double k3, double k4, double k5,
                                     double mu, double mv, double u0, double v0)
...
int EquidistantCamera::imageWidth() const {
  return mParameters.imageWidth();
}

int EquidistantCamera::imageHeight() const {
...
void EquidistantCamera::estimateIntrinsics(const cv::Size& boardSize,
  ...
  rvecs.assign(objectPoints.size(), cv::Mat()); // 用val填充n个元素的容器
...
cv::Mat EquidistantCamera::initUndistortRectifyMap(cv::Mat& map1, cv::Mat& map2, float fx, float fy,
                                                   cv::Size imageSize, float cx, float cy, cv::Mat rmat) const {
