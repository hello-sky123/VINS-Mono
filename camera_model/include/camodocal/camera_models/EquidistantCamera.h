...
class EquidistantCamera: public Camera {
 public:
   class Parameters: public Camera::Parameters {
    public:
      Parameters();
      Parameters(const std::string& cameraName, int w, int h, double k2, double k3, double k4, double k5,
   ...
   */
   EquidistantCamera(const std::string& cameraName, int imageWidth, int imageHeight, double k2, double k3, double k4, double k5,
                     double mu, double mv, double u0, double v0);
   /**
   * \brief Constructor from the projection model parameters
   */
...
template<typename T>
T EquidistantCamera::r(T k2, T k3, T k4, T k5, T theta) {  // r和theta的关系
  // k1 = 1
  return theta +
